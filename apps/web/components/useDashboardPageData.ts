...
export function useDashboardPageData() {
  ...
  async function handleRunStrategyOnce(symbols?: Array<'BTC_USDT' | 'ETH_USDT'>, overrideLeverage?: number, overrideTradeMode?: 'paper' | 'live', overrideDirectionMode?: 'auto' | 'long_only' | 'short_only', dryRun = false) {
    ...
    const payload: RunnerRequestPayload = {
      ...
      ifvg_risk_reward: activeStrategy.ifvg_risk_reward,
      ifvg_fvg_lookback: activeStrategy.ifvg_fvg_lookback,
      ifvg_min_fvg_width_pct: activeStrategy.ifvg_min_fvg_width_pct,
      ifvg_bias_ema_period: activeStrategy.ifvg_bias_ema_period,
      ifvg_session: activeStrategy.ifvg_session,
      ifvg_require_bias: activeStrategy.ifvg_require_bias,
      ifvg_one_shot_per_session: activeStrategy.ifvg_one_shot_per_session,
